	...
	class EMD_MB_Image_Advanced_Field extends EMD_MB_Image_Field
	{
		...
		static function admin_enqueue_scripts()
		{
			...
			wp_localize_script( 'emd-mb-image-advanced', 'emdmbImageAdvanced', array(
				'frameTitle' => __( 'Select Images', 'youtube-showcase' ),
			) );
		}
		...
		{
			$i18n_title = apply_filters( 'emd_mb_image_advanced_select_string', _x( 'Select or Upload Images', 'image upload', 'youtube-showcase' ), $field );
		...
		{
			$i18n_delete = apply_filters( 'emd_mb_image_delete_string', _x( 'Delete', 'image upload', 'youtube-showcase' ) );
			$i18n_edit   = apply_filters( 'emd_mb_image_edit_string', _x( 'Edit', 'image upload', 'youtube-showcase' ) );
			?>
